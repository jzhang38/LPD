...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_mask_prob",  type=float,
                        default=0.7)
    parser.add_argument("--exclude_fewrel",action="store_true",
                    )
    ...
    create_exp_dir('past_run_code/'+ args.save_dir, scripts_to_save=['code/dataset.py', 'code/main.py', 'code/model.py', 'code/prepare_data.py'])
